...
- `../notes/parte-19.md`: market-basket model, support, confidence, interest
- `../notes/parte-20.md`: A-Priori, monotonicity, pair counting, triangular matrix vs triples
- `../notes/parte-21.md`: PCY, Multistage, Multihash, sampling
- `../notes/parte-22.md`: limited-pass algorithms, SON, Toivonen, MapReduce framing
- `../notes/parte-23.md`: frequent items in streams, decaying windows, hybrid methods
