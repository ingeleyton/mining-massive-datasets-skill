# parte-16 — Mining-of-Massive-Datasets-Third-Edition-Jure-Leskovec-Anand-Rajaraman-etc-z-library-sk-1lib-sk-z-lib-parte-16.pdf

## 1. Metadatos del documento
- **Libro:** Mining of Massive Datasets, 3ª ed.
- **Fragmento/Parte:** Sección 5.2 (Efficient Computation of PageRank) y Sección 5.3.1 (Motivation for Topic-Sensitive PageRank).
