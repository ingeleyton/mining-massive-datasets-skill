# parte-11 — Mining-of-Massive-Datasets-Third-Edition-Jure-Leskovec-Anand-Rajaraman-etc-z-library-sk-1lib-sk-z-lib-parte-11.pdf

## 1. Metadatos del documento
- **Libro:** Mining of Massive Datasets, 3ª ed.
- **Fragmento/Parte:** Capítulo 3, Secciones 3.8, 3.9, 3.10, 3.11 (Aplicaciones de LSH y Métodos para Alta Similitud)
